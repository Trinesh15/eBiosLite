...
public class PayInsAmtusingVisorCreditcard extends BaseTest
{
	@Test
	public void testPayInsAmtusingVisorCreditcard() throws InterruptedException
	{
		...
		String Amt = Excel.getCellData(INPUT, "Receipts", 8, 1);
