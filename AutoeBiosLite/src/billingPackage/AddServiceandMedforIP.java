...
public class AddServiceandMedforIP extends BaseTest
{
	@Test
	public void testAddServicesforOP() throws InterruptedException 
	{
		...
		String medication1 = Excel.getCellData(INPUT, "Billing", 2, 3);
		String medication2 = Excel.getCellData(INPUT, "Billing", 3, 3);
