...
public class SaveBillforDecimalAmt extends BaseTest
{
	@Test
	public void testSaveBillforLessAmt() throws InterruptedException 
	{
		...
		String UHID = Excel.getCellData(INPUT, "BillingFields", 2, 14);
		String Amt =  Excel.getCellData(INPUT, "BillingFields", 11, 14);
		...
		for(int n=8;n<=9;n++) 
		{
			String code = Excel.getCellData(INPUT, "BillingFields", n, 14);	
			bp.AddServices(code);
		}
		bp.ScrolltoPayment();
		bp.selectCash();
