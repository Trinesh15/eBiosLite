...
public class VerifySeenPatient extends BaseTest {
	@Test
	private void testVerifySeenPatient() throws InterruptedException {
		...
		rp.clickSeenPatientinAdv();
		rp.verifySeenPatientinAdv();
	}
