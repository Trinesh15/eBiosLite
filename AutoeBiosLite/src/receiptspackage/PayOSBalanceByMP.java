...
public class PayOSBalanceByMP extends BaseTest
{
	@Test
	public void testPayOSBalanceByMP() throws InterruptedException
	{
		...
		//creating object of login page and access the required methods.
				...
				rp.setAmountinPatient(Amt);
				rp.setReferenceNumberin1st(Refnum);
				rp.clickBankDd();
				rp.clickonAlphaBank();
				rp.clickNew();
				rp.ClickAmountin2nd();
				rp.setAmountin2nd(Amt);
