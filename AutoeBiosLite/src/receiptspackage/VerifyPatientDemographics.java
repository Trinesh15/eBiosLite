...
public class VerifyPatientDemographics extends BaseTest
{
	@Test
	public void testVerifyPatientDemographics() throws InterruptedException
	{
		...
		//creating object of login page and access the required methods.
				...
				rp.clickOkinAlert();
				rp.clickSearch();
				rp.clickPatientDemoLink();
				rp.VerifyPatientDemographic();
