...
public class SearchOutPatient extends BaseTest
{
	@Test
	public void testSearchOutPatient() throws InterruptedException
	{
		...
		//String Code = Excel.getCellData(INPUT, "Receipts", 7, 1);
